...
import (
	...
	infrastructurev1alpha3 "github.com/benmoss/cluster-api-provider-kubemark/api/v1alpha3"
)

// KubemarkMachineTemplateReconciler reconciles a KubemarkMachineTemplate object
...
func (r *KubemarkMachineTemplateReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	_ = context.Background()
	_ = r.Log.WithValues("kubemarkmachinetemplate", req.NamespacedName)
...
func (r *KubemarkMachineTemplateReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&infrastructurev1alpha3.KubemarkMachineTemplate{}).
		Complete(r)
}
